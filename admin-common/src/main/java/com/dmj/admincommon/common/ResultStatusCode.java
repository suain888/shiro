...
public enum ResultStatusCode {
    ...
    NOT_EXIST_USER(10000, "该用户不存在或者用户名密码错误"),
    USER_AUTHER_ERROR(10001, "用户认证失败"),
    NOT_PERMISSION(10005,"您没有该权限"),

    DELETE_ERROR(50000,"系统默认角色，无法删除"),
    DELETE_ERROR_INFO(50001,"角色管理管理员，请先解绑");
